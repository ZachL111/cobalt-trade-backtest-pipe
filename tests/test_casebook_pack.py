"""Regression checks for the cobalt-trade-backtest-pipe casebook."""
...
from casebook.harness import assert_expected, cobalt_trade_backtest_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_trade_backtest_pipe_summary(), assert_expected())
